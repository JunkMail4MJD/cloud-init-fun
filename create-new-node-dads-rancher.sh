...
runcmd:
  ...
  - "ls -alGh /root/"
  - "ls -alGh /etc/docker"
  - "sudo docker run -d --privileged --restart=unless-stopped --net=host -v /etc/kubernetes:/etc/kubernetes -v /var/run:/var/run rancher/rancher-agent:v2.1.3 --server https://10.0.205.109 --token 56clg89j5ckddlrb5n2j55tkrhnw2wrmz98xsl28rw24998xddbc2q --ca-checksum f2c5709e62ef7c682c4842bad843035b8237ae5653127a708bf49ec3a31adf57 --etcd --controlplane --worker"
EOF
...
VBoxManage import appliances/empty-cloudimg.ovf --vsys 0 --vmname "$vmname" --cpus 1 --memory 6000
